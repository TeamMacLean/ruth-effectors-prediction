...
In this report, the fully conected model will be developed for the encoded effector and non-effector data. 

## Introduction

Since new encoding method was done, we will use two kind of data on the same models. 
...
There are two kind of data that will be used for each model, which are encoded by integer encoding and also onehot encoding. 
...
We need to reshape the data in order so it can be fed to fully connected model.
