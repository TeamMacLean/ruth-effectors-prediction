...
df_result_hyper_tuned.to_csv('/hpc-home/kristian/effector-non-effector/scripts-cnn-lstm-separate-group/scripts-scan-multiclass/all/results/all_scan_results_gru_emb_scan_all_data.csv')
...
df_results.to_csv('/hpc-home/kristian/effector-non-effector/scripts-cnn-lstm-separate-group/scripts-scan-multiclass/all/results/df_pred_results_gru_embedding_scan_all.csv')
