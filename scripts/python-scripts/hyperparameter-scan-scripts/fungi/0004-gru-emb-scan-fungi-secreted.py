...
x_train = np.load('/hpc-home/kristian/effector-non-effector/scripts-cnn-lstm-separate-group/data-fungi/secreted_non_identical/x_train_int_fungi.npy')
...
x_dev = np.load('/hpc-home/kristian/effector-non-effector/scripts-cnn-lstm-separate-group/data-fungi/secreted_non_identical/x_val_int_fungi.npy')
...
x_test = np.load('/hpc-home/kristian/effector-non-effector/scripts-cnn-lstm-separate-group/data-fungi/secreted_non_identical/x_test_int_fungi.npy')
...
keras_param_options = {'outputdim' : [8, 16, 32],
...
df_result_hyper_tuned.to_csv('/hpc-home/kristian/effector-non-effector/scripts-cnn-lstm-separate-group/scripts-scan-multiclass/fungi/results/fungi_scan_results_gru_embedding_scan_fungi.csv')

# Save fungi of the params to be used to predict
...
# Predict the results of hyperparamaters tuning for fungi parameters
...
df_results.to_csv('/hpc-home/kristian/effector-non-effector/scripts-cnn-lstm-separate-group/scripts-scan-multiclass/fungi/results/df_pred_results_gru_embedding_scan_fungi.csv')
