...
keras_param_options = {'filter_conv' : [8, 16],
					             'kernel_size' : [1, 2],
					             'maxpool_size' : [2, 3],
...
df_result_hyper_tuned.to_csv('/hpc-home/kristian/effector-non-effector/scripts-cnn-lstm-separate-group/scripts-scan-multiclass/fungi/results/all_scan_results_cnn_gru_fungi_secreted.csv')
...
df_results.to_csv('/hpc-home/kristian/effector-non-effector/scripts-cnn-lstm-separate-group/scripts-scan-multiclass/fungi/results/df_pred_results_cnn_gru_fungi_secreted.csv')
