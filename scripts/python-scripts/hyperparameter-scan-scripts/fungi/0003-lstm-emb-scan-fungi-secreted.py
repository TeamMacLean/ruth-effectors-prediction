...
df_result_hyper_tuned.to_csv('/hpc-home/kristian/effector-non-effector/scripts-cnn-lstm-separate-group/scripts-scan-multiclass/fungi/results/all_scan_results_lstm_emb_scan_fungi.csv')
...
df_results.to_csv('/hpc-home/kristian/effector-non-effector/scripts-cnn-lstm-separate-group/scripts-scan-multiclass/fungi/results/df_pred_results_lstm_emb_scan_fungi.csv')
