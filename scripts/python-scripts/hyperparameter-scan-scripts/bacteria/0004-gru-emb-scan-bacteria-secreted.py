...
keras_param_options = {'outputdim' : [32, 48],
...
df_result_hyper_tuned.to_csv('/hpc-home/kristian/effector-non-effector/scripts-cnn-lstm-separate-group/scripts-scan-multiclass/bacteria/results/bacteria_scan_results_gru_embedding_scan_bacteria.csv')

# Save bacteria of the params to be used to predict
...
# Predict the results of hyperparamaters tuning for bacteria parameters
...
df_results.to_csv('/hpc-home/kristian/effector-non-effector/scripts-cnn-lstm-separate-group/scripts-scan-multiclass/bacteria/results/df_pred_results_gru_embedding_scan_bacteria.csv')
