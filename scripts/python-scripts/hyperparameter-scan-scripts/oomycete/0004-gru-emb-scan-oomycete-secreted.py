...
model = KerasClassifier(build_fn =  simple_GRU, verbose = 1)

# Define the parameters that will be tuned randomly
keras_param_options = {'outputdim' : [32, 48, 64],
                       'gru_hidden_units' : [8, 16, 32, 64],
                       'opt_dropout' : [0, 0.25, 0.5],
                       'opt_dropout_recurrent' : [0, 0.25, 0.5],
                       'opt_go_backwards' : ['FALSE', 'TRUE'],
                       'reg_rate' : [0.01, 0.001],
...
df_result_hyper_tuned.to_csv('/hpc-home/kristian/effector-non-effector/scripts-cnn-lstm-separate-group/scripts-scan-multiclass/oomycete/results/oomycete_scan_results_gru_embedding_scan_oomycete.csv')

# Save oomycete of the params to be used to predict
...
# Predict the results of hyperparamaters tuning for oomycete parameters
...
df_results.to_csv('/hpc-home/kristian/effector-non-effector/scripts-cnn-lstm-separate-group/scripts-scan-multiclass/oomycete/results/df_pred_results_gru_embedding_scan_oomycete.csv')
