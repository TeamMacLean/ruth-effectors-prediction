...
x_train = np.load('/hpc-home/kristian/effector-non-effector/scripts-cnn-lstm-separate-group/data-oomycete/secreted_non_identical/x_train_int_oomycete.npy')
...
x_dev = np.load('/hpc-home/kristian/effector-non-effector/scripts-cnn-lstm-separate-group/data-oomycete/secreted_non_identical/x_val_int_oomycete.npy')
...
x_test = np.load('/hpc-home/kristian/effector-non-effector/scripts-cnn-lstm-separate-group/data-oomycete/secreted_non_identical/x_test_int_oomycete.npy')
...
df_result_hyper_tuned.to_csv('/hpc-home/kristian/effector-non-effector/scripts-cnn-lstm-separate-group/scripts-scan-multiclass/oomycete/results/all_scan_results_lstm_emb_scan_oomycete.csv')


# Read the  dataframe saved into pandas before

df_result_hyper_tuned = pd.read_csv('/hpc-home/kristian/effector-non-effector/scripts-cnn-lstm-separate-group/scripts-scan-multiclass/oomycete/results/all_scan_results_lstm_emb_scan_oomycete.csv')
...
param_best_model_dict = df_result_hyper_tuned.nlargest(30, 'mean_test_score')['params']
...
for i in range(len(param_best_model_dict)):
    params_dict = ast.literal_eval(param_best_model_dict[i])
    list_par = list(params_dict.values())
...
df_results.to_csv('/hpc-home/kristian/effector-non-effector/scripts-cnn-lstm-separate-group/scripts-scan-multiclass/oomycete/results/df_pred_results_lstm_emb_scan_oomycete.csv')
