...
x_train = np.load('/hpc-home/kristian/effector-non-effector/scripts-cnn-lstm-separate-group/data-all/secreted_non_identical/x_train_all.npy')
...
x_dev = np.load('/hpc-home/kristian/effector-non-effector/scripts-cnn-lstm-separate-group/data-all/secreted_non_identical/x_val_all.npy')
...
x_test = np.load('/hpc-home/kristian/effector-non-effector/scripts-cnn-lstm-separate-group/data-all/secreted_non_identical/x_test_all.npy')
...
for train, test in kfold.split(x_train, y_train):
    model = simple_CNN_GRU(filter_conv = 16,
			                    kernel_size = 1,
			                    maxpool_size = 2,
	...
	# Fit the model
    history_fit = model.fit(x_train[train], y_train[train], epochs = 40, batch_size = 16, verbose = 1, shuffle = 1, validation_data = (x_train[test], y_train[test]))
...
df_results_train.to_csv('/hpc-home/kristian/effector-non-effector/scripts-cnn-lstm-separate-group/scripts-manual-train/df_results_train_cnn_gru_best_all_convfilter16_kernel1.csv')
df_results_val.to_csv('/hpc-home/kristian/effector-non-effector/scripts-cnn-lstm-separate-group/scripts-manual-train/df_results_val_cnn_gru_best_all_convfilter16_kernel1.csv')
df_results_test.to_csv('/hpc-home/kristian/effector-non-effector/scripts-cnn-lstm-separate-group/scripts-manual-train/df_results_test_cnn_gru_best_all_convfilter16_kernel1.csv')
