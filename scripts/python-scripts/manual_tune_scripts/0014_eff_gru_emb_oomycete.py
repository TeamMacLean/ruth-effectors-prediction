...
for train, test in kfold.split(x_train, y_train):
    model = simple_GRU(inputdim = 23,
                       ...
                       gru_hidden_units = 16,
                       opt_dropout = 0.25,
                       opt_dropout_recurrent = 0.25,
                       opt_go_backwards = 'TRUE',
                       reg_rate = 0.01,
                       optimizers = 'sgd'
                      )
    # Fit the model
    history_fit = model.fit(x_train[train], y_train[train], epochs = 60, batch_size = 4, verbose = 1, shuffle = 1, validation_data = (x_train[test], y_train[test]))
...
df_results_train.to_csv('/hpc-home/kristian/effector-non-effector/scripts-cnn-lstm-separate-group/scripts-manual-train/results/oomycete/df_results_train_gru_emb_oomycete_60epochs.csv')
df_results_val.to_csv('/hpc-home/kristian/effector-non-effector/scripts-cnn-lstm-separate-group/scripts-manual-train/results/oomycete/df_results_val_gru_emb_oomycete_60epochs.csv')
df_results_test.to_csv('/hpc-home/kristian/effector-non-effector/scripts-cnn-lstm-separate-group/scripts-manual-train/results/oomycete/df_results_test_gru_emb_oomycete_60epochs.csv')
