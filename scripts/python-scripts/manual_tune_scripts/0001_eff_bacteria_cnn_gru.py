...
x_train = np.load('/hpc-home/kristian/effector-non-effector/scripts-cnn-lstm-separate-group/data-bacteria/secreted_non_identical/x_train_bacteria.npy')
...
x_dev = np.load('/hpc-home/kristian/effector-non-effector/scripts-cnn-lstm-separate-group/data-bacteria/secreted_non_identical/x_val_bacteria.npy')
...
x_test = np.load('/hpc-home/kristian/effector-non-effector/scripts-cnn-lstm-separate-group/data-bacteria/secreted_non_identical/x_test_bacteria.npy')
...
df_results_train.to_csv('/hpc-home/kristian/effector-non-effector/scripts-cnn-lstm-separate-group/scripts-manual-train/df_results_train_cnn_gru_best_bacteria.csv')
df_results_val.to_csv('/hpc-home/kristian/effector-non-effector/scripts-cnn-lstm-separate-group/scripts-manual-train/df_results_val_cnn_gru_best_bacteria.csv')
df_results_test.to_csv('/hpc-home/kristian/effector-non-effector/scripts-cnn-lstm-separate-group/scripts-manual-train/df_results_test_cnn_gru_best_bacteria.csv')
