...
df_results_train.to_csv('/hpc-home/kristian/effector-non-effector/scripts-cnn-lstm-separate-group/scripts-manual-train/results/df_results_train_cnn_lstm_best_oomycete_60epochs.csv')
df_results_val.to_csv('/hpc-home/kristian/effector-non-effector/scripts-cnn-lstm-separate-group/scripts-manual-train/results/df_results_val_cnn_lstm_best_oomycete_60epochs.csv')
df_results_test.to_csv('/hpc-home/kristian/effector-non-effector/scripts-cnn-lstm-separate-group/scripts-manual-train/results/df_results_test_cnn_lstm_best_oomycete_60epochs.csv')
