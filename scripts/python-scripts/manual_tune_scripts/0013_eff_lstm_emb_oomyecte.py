...
for train, test in kfold.split(x_train, y_train):
    ...
    # Fit the model
    history_fit = model.fit(x_train[train], y_train[train], epochs = 30, batch_size = 4, verbose = 1, shuffle = 1, validation_data = (x_train[test], y_train[test]))
...
df_results_train.to_csv('/hpc-home/kristian/effector-non-effector/scripts-cnn-lstm-separate-group/scripts-manual-train/results/oomycete/df_results_train_lstm_emb_oomycete_lstm16_outputdim_32.csv')
df_results_val.to_csv('/hpc-home/kristian/effector-non-effector/scripts-cnn-lstm-separate-group/scripts-manual-train/results/oomycete/df_results_val_lstm_emb_oomycete_lstm16_outputdim_32.csv')
df_results_test.to_csv('/hpc-home/kristian/effector-non-effector/scripts-cnn-lstm-separate-group/scripts-manual-train/results/oomycete/df_results_test_lstm_emb_oomycete_lstm16_outputdim_32.csv')
