...
for train, test in kfold.split(x_train, y_train):
    model = simple_CNN_GRU(filter_conv = 32,
			                     kernel_size = 1,
			                     maxpool_size = 2,
...
df_results_train.to_csv('/hpc-home/kristian/effector-non-effector/scripts-cnn-lstm-separate-group/scripts-manual-train/df_results_train_cnn_gru_best_modified.csv')
df_results_val.to_csv('/hpc-home/kristian/effector-non-effector/scripts-cnn-lstm-separate-group/scripts-manual-train/df_results_val_cnn_gru_best_modified.csv')
df_results_test.to_csv('/hpc-home/kristian/effector-non-effector/scripts-cnn-lstm-separate-group/scripts-manual-train/df_results_test_cnn_gru_best_modified.csv')
