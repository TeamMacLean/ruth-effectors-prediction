...
df_results_train.to_csv('/hpc-home/kristian/effector-non-effector/scripts-cnn-lstm-separate-group/scripts-manual-train/results/bacteria/df_results_train_gru_emb_bacteria.csv')
df_results_val.to_csv('/hpc-home/kristian/effector-non-effector/scripts-cnn-lstm-separate-group/scripts-manual-train/results/bacteria/df_results_val_gru_emb_bacteria.csv')
df_results_test.to_csv('/hpc-home/kristian/effector-non-effector/scripts-cnn-lstm-separate-group/scripts-manual-train/results/bacteria/df_results_test_gru_emb_bacteria.csv')
