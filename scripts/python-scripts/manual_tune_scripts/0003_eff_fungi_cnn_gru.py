...
df_results_train.to_csv('/hpc-home/kristian/effector-non-effector/scripts-cnn-lstm-separate-group/scripts-manual-train/df_results_train_cnn_gru_best_fungi_60epochs_filterconv8_drop025.csv')
df_results_val.to_csv('/hpc-home/kristian/effector-non-effector/scripts-cnn-lstm-separate-group/scripts-manual-train/df_results_val_cnn_gru_best_fungi_60epochs_filterconv8_drop025.csv')
df_results_test.to_csv('/hpc-home/kristian/effector-non-effector/scripts-cnn-lstm-separate-group/scripts-manual-train/df_results_test_cnn_gru_best_fungi_60epochs_filterconv8_drop025.csv')
